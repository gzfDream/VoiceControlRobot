...
public:
	...
	// 初始化Kinect
	HRESULT init_kinect();
	bool show_pointCloud(pcl::PointCloud<pcl::PointXYZ>::Ptr &m_pointcloud, 
...
private:
	...
	bool PointCloud_Process(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, std::vector<Eigen::Vector4f, Eigen::aligned_allocator<Eigen::Vector4f>> &vec);
