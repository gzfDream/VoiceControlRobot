...
#endif
const char * GRM_FILE = "bin/command.bnf"; //构建离线识别语法网络所用的语法文件
...
{
	login_config = "appid = 5a409dde"; //登录参数
...
//int Voice_process::update_lex_cb(int ecode, const char *info, void *udata)
//{
...
//}
//
//int Voice_process::update_lexicon(UserData *udata)
//{
...
const char* get_audio_file(void)
{
	...
	while (key != 27) //按Esc则退出
	{
		...
		case '1':
			printf("\n1.打电话给丁伟\n");
			return "voiceData/ddhgdw.pcm";
		case '2':
			printf("\n2.打电话给黄辣椒\n");
			return "voiceData/ddhghlj.pcm";
		default:
			continue;
		}
	}
